// FIXED: Uses TaskEnvironment.GetAbsolutePath() instead of Path.GetFullPath() throughout
using System;
    ...
    public class ArtifactPublisher : Microsoft.Build.Utilities.Task, IMultiThreadableTask
    {
        ...
        public override bool Execute()
        {
            try
            {
                ...
                string targetDir = TaskEnvironment.GetAbsolutePath(PublishDirectory);
                ...
                {
                    // FIX: uses TaskEnvironment.GetAbsolutePath via ResolveOutputPath
        ...
        private void WriteManifest(List<ManifestEntry> entries)
        {
            ...
            // FIX: uses TaskEnvironment.GetAbsolutePath instead of Path.GetFullPath
            string manifestFullPath = TaskEnvironment.GetAbsolutePath(ManifestPath);
            ...
            // FIX: path already resolved via TaskEnvironment above
